...
var pipeline = function(inupt, callback1, callback2){
    var callbacks = [callback1, callback2]
    callbacks.forEach(function(input) {
        callback1(callback2(input))
    })
...
var map = function(arr, callback){
    var arrHack = function(index){
        (callback(index) + "X")
    }

    arrHack = Array.protoype.forEach
    arr.arrHack()
}
...
// var Place = function () {
//     this.fetchData = function(location) {
//         var ajaxParams = {
//             url: "https//maps.googleapis.com/maps/api/geocode/json"
//             data: {
//                 address: location
//                 key: "AIzaSyC7tVO2YsFmbk4BV2E8WzKiCrWFai_GjHY"
